...
export function AvatarUploadForm({ avatar, onAvatarSaved, onUnauthorized }: AvatarUploadFormProps) {
...
async function getAvatarApiError(response: Response): Promise<string> {
  try {
  ...
  return 'Не удалось загрузить аватар. Повторите попытку.';
}
